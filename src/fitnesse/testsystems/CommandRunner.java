...
//  protected int exitCode = -1;
  ...
  protected void redirectOutputs(Process process, final ExecutionLogListener executionLogListener) throws IOException {
    ...
    // Fit and SlimService
    new Thread(new OutputReadingRunnable(stdout, executionLogListener::stdOut), "CommandRunner stdOut").start();
    new Thread(new OutputReadingRunnable(stderr, (String output) -> {
